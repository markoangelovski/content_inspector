<div class="bg-zinc-900 rounded-lg border border-zinc-800 p-6 text-white"
    ...
    @if ($run)
        ...
        <div class="mb-6">
            ...
            <div class="w-full bg-zinc-800 rounded-full h-2 overflow-hidden">
                <div class="h-full transition-all duration-500 bg-yellow-500" style="width: {{ $progress }}%"></div>
            </div>
        </div>
